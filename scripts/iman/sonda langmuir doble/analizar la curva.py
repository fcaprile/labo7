...
#%%
tensiones,corrientes,error_corrientes=np.loadtxt('curva carac 1000V con t entre 0,5 y 1,5.txt',delimiter='\t')
...
analisis_simetrico(tensiones,corrientes,error_corrientes,0,20,45,60,rama_pos=True)    
