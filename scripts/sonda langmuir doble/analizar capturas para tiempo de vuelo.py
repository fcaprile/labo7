...
#carpeta='C:/Users/DG/Documents/GitHub/labo6_2/mediciones/8-23/6.5/'

tinf=2*10**-6
tsup=6*10**-6
  
distancias,vuelo_medio,desviación=tiempo_vuelo(carpeta_madre,tinf,tsup,fc=20*10**5,order=2,reduction=0.8 ,punta=10,n_vecinos=50)
'''
#funcan: fc=7*10**5,order=4,reduction=0.7       da 6.12638808829e-08
