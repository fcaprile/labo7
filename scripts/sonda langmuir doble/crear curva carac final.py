# -*- coding: utf-8 -*-
"""
Created on Wed Nov 20 14:47:27 2019
...
#        print(np.mean(descarga_media))
    ...
    error_corriente_media=np.array(error_corriente_media)
    corriente_media*=np.mean(descarga_media)
    error_corriente_media*=np.mean(descarga_media)
#    tensiones=[]
#    for i in indice_carpetas:
